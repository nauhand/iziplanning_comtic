...
class SiteAllExcel implements FromCollection, ShouldAutoSize, WithEvents, WithDrawings, WithHeadings
{
    // private $agent;
    private $sites;
    ...
    {   
      ...
      $this->sites = Site::where('deleted_at', null)->get();
    ...
    */
    public function collection()
    {
       ...
       foreach($this->sites as $key => $site) 
       {
            $donneeExcel[] = array(
                ...
                'VILLE' => $site->ville  ,
                'TEL'   => $site->telephone  ,
                'NOM DU MANAGER'  => $site->nommanager  ,
                'TEL DU MANAGER'=> $site->telephonemanager   ,
            );
       }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $cellRange = 'A1:H' . ( $this->sites->count() + 5 );
                ...
                $event->sheet->setCellValue(sprintf('A9'),'LISTE DES SITES  ');
    ...
    {
        return array( 'N°','NOM DU SITE', 'ADRESSE', 'EMAIL', 'VILLE', 'TEL', 'NOM DU MANAGER', 'TEL DU MANAGER');
    }
