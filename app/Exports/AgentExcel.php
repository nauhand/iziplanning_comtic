...
class AgentExcel implements FromCollection, ShouldAutoSize, WithEvents, WithDrawings, WithHeadings
{
    public $agent;
    
    public function __construct( $id ) 
    {
        $this->agent = Agent::find($id)[0];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $cellRange = 'A1:AF' . ( $this->agent->count() + 5 );
