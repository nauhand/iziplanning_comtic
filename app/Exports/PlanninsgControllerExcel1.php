...
class PlanninsgControllerExcel1 implements FromCollection, ShouldAutoSize, WithEvents, WithDrawings, WithHeadings
{
    // private $agent;
    private $plannings;
    private $total ;
...
//                $event->sheet->getStyle('F14')->applyFromArray($style_text_center);
               ...
               // $event->sheet->setCellValue(sprintf('E8'),'Tel : 01 41 38 68 11');
                ...
                $event->sheet->setCellValue(sprintf('E10'),'PLANNING "PROVISOIRE" DU MOIS  ' .  strtoupper(Carbon::now()->monthName ). '');
