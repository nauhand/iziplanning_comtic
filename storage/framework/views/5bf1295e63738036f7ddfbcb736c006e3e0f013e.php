...
<?php $__env->startSection('content'); ?>
    ...
    <?php if($message = Session::get('successvacation')): ?>
        <div class="alert alert-success alert-dismissible show" id="notification" role="alert" style="position:absolute;right:0;z-index: 5">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
    ...
    <?php if($message = Session::get('successdelete')): ?>
        <div class="alert alert-success alert-dismissible show" id="notification" role="alert" style="position:absolute;right:0;z-index: 5">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-solid">
                            ...
                            <p class="text-center" style="font-size: 20px;">Total des heures :  <strong><?php echo e(\App\Helpers\BlackshFonctions::format($totale_h.':'.$total_m.':00')); ?></strong><b></b></p>
                                                            ...
                                                            <div class="box-header" style="position: absolute; z-index: 1; margin-top: 10px;">
                                                                ...
                                                                <div class="box-tools pull-left" style="margin-right: 15px">
                                                                    <div class="input-group input-group-sm hidden-xs" style="width: 30px;">
                                                                        <a class="btn btn-sm btn-social btn-vk generer-pdfIndiv" href="<?php echo e(route('planning.provisoire.pdf',['type' => 'provisoire'])); ?>" target="_blank" style="background-color: #c72121;">
                                                                ...
                                                                <div class="box-tools pull-left" style="margin-right: 15px">
                                                                    <div class="input-group input-group-sm hidden-xs" style="width: 30px;">
                                                                        <a class="btn btn-sm btn-social btn-vk generer-excelIndiv" href="<?php echo e(route('planning.provisoire.excel',['type' => 'provisoire'])); ?>" target="_blank" style="background-color: #0b7728;">
                                                                ...
                                                                <div class="box-tools pull-left" style="margin-right: 15px">
                                                                    <div class="input-group input-group-sm hidden-xs" style="width: 30px;">
                                                                        <form class="valider_tout_planning" action="<?php echo e(route('provisoire.dataofcrea')); ?>" method="post" style="display: inline;">
                                                                            <?php echo csrf_field(); ?>
                                                                ...
                                                                <div class="box-tools pull-left" style="margin-right: 15px">
                                                                    <div class="input-group input-group-sm hidden-xs" style="width: 30px;">
                                                                        <a class="btn btn-sm btn-social btn-vk generer-pdfIndiv" href="<?php echo e(route('planning.create')); ?>" style="background-color: gray;">
                                                                ...
                                                                <?php if($data): ?>
                                                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo e(ucfirst(\Carbon\Carbon::parse($p->created_at)->locale('fr_FR')->isoFormat('ddd  DD, MM YYYY'))); ?></td>
                                                                            <td> <?php echo e($p->nom); ?></td>
                                                                            <td><?php echo e($p->prenoms); ?></td>
                                                                            <td><?php echo e(\App\Helpers\BlackshFonctions::format($heures_total_hours . ':'.$minutes_jours.':0')); ?> </td>
                                                                            <td><?php echo e(\App\Helpers\BlackshFonctions::format($heure_total_nuit . ':'.$minutes_nuit.':0')); ?> </td>
                                                                            <td><?php echo e(\App\Helpers\BlackshFonctions::format($total.':'.$minutes.':0')); ?> </td>
                                                                            <td> <span class="badge badge-info">provisoire</span></td>
                                                                            <td>
                                                                                <form class="voir_un_planning" action="<?php echo e(route('provisoire.show',$p->id)); ?>" method="get" style="display: inline;">
                                                                                    <?php echo csrf_field(); ?>
                                                                                    <input type="hidden" name="vacationid" value="<?php echo e($p->vacation_id); ?>">
                                                                                ...
                                                                                <form class="valider_un_planning" action="<?php echo e(route('provisoire.update',$p->id)); ?>" method="post" style="display: inline;">
                                                                                    <?php echo csrf_field(); ?>
                                                                                    <?php echo method_field('put'); ?>
                                                                                    <input type="hidden" name="vacationid" value="<?php echo e($p->vacation_id); ?>">
                                                                                ...
                                                                                <form class="supprimer_un_planning" action="<?php echo e(route('provisoire.destroy',$p->id)); ?>" method="post" style="display: inline;">
                                                                                    <?php echo csrf_field(); ?>
                                                                                ...
                                                                                <a href="<?php echo e(route('planning.provisoire.vaccation.excel', $p->id)); ?>" data-toggle="tooltip" data-placement="top" title="Télécharger ce planning" style="border: none; height: 17px;" class="label label-success label-sm" data-toggle="tooltip" data-placement="top"><i class="fa fa-file-excel-o BTN-VK"></i> | EXCEL</a>
                                                                                <a href="<?php echo e(route('planning.provisoire.vaccation.pdf', $p->id)); ?>" data-toggle="tooltip" data-placement="top" title="Télécharger ce planning" style="border: none; height: 17px;" class="label label-danger label-sm" data-toggle="tooltip" data-placement="top"><i class="fa fa-file-pdf-o BTN-VK"></i> | PDF</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iziplanning\resources\views/pages/plannings/planning-provisoires.blade.php ENDPATH**/ ?>