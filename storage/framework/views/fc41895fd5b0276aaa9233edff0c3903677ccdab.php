        ...
        <div class=" rcv_parent">
          ...
          <span>
            <img src="<?php echo e(asset('')); ?>assets/img/ic_heure.png" alt="">
                ...
                <div class="title_box_rcv">
                    <h1 class="title_rcv">  </h1>
                    <p class="action_title_rcv color_blue">   </p>
                </div>
                <div class="footer_rcv">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iziplanning\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>