    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Information sur l'admin</h3>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="box box-solid">
                  ...
                  <!-- form start -->
                  <form role="form" action="{{ route('account.post')}}" method="post">
                  @csrf
                    <!-- /.box-header -->
                    <div class="box-body">
                            ...
                            <div class="box-body">
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="form-group @error('email')  has-error @enderror">
                                  <label>Email</label>
                                  <input name="email" type="email" class="form-control"  placeholder="Entrer l'adresse Email" value="{{old('email') ?: ''}}">
                                  @error('email')
                                      <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> {{$message}}</label>
                                  @enderror
                                </div>
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="form-group @error('numeromobile')  has-error @enderror">
                                  ...
                                  <input name="numeromobile" type="text" class="form-control"  placeholder="Entrer le numero" value="{{old('numeromobile') ?: ''}}">
                                  @error('numeromobile')
                                      <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> {{$message}}</label>
                                  @enderror
                                </div>
