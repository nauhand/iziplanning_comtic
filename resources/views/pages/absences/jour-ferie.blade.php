  ...
  <section class="content">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title"><strong>Liste des agents ayant travaillé des jours fériés ce mois</strong></h3>
                  ...
                  <table id="datatable_vac" class="table table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                            <a href="{{ route('jourferies.show', $value->id) }}" class="label label-primary label-sm"><i class="fa fa-eye"></i></a>
                          </td>          
                      </tr>
                      @endforeach
                    </tbody>
