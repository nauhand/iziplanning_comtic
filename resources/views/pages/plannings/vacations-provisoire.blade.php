                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-solid">
                            ...
                            <p class="text-center">Planning provisoire de l'agent  : <strong>{{ $agent->nom }} {{ $agent->prenoms }}</strong><b></b></p>
                            ...
                            <p class="text-center">Total Heures du planning:  <strong>{{ \App\Helpers\BlackshFonctions::format($totale_h.':'.$total_m.':00') }}</strong><b></b></p>
                                    ...
                                    <div class="box-header" style="position: absolute; z-index: 1;">
                                        ...
                                        <div class="box-tools pull-left" style="margin-right: 15px">
                                            <div class="input-group input-group-sm hidden-xs" style="width: 30px;">
                                                <a class="btn btn-sm btn-social btn-vk generer-pdfIndiv" href="{{ route('planning.provisoire.vaccation.pdf', $agent->id)}}" target="_blank" style="background-color: #c72121;">
                                        ...
                                        <div class="box-tools pull-left" style="margin-right: 15px">
                                            <div class="input-group input-group-sm hidden-xs" style="width: 30px;">
                                                <a class="btn btn-sm btn-social btn-vk generer-excelIndiv" href="{{ route('planning.provisoire.vaccation.excel', $agent->id)}}" target="_blank" style="background-color: #0b7728;">
                ...
                <form action="{{ route('actionprovisoire.store') }}" method="post" id="addv">
                   ...
                   <i class="glyphicon glyphicon-remove-sign"></i> <strong>{{ $message }}</strong>
                    ...
                    <i class="glyphicon glyphicon-remove-sign"></i> <strong>{{ $message }}</strong>
                        ...
                        <label for="datedebut">Date début : </label>
                        <div class="input-group date" style="width: 100%;">
                            <input type="date" class="form-control @error('datedebut') is-invalid @enderror datedebut_add" name="datedebut" id="datedebut">
                      ...
                      <i class="glyphicon glyphicon-remove-sign"></i> <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group">
                            <label for="heuredebut">Heure début : </label>
                            <input type="time" class="form-control @error('heuredebut') is-invalid @enderror heuredebut_add" name="heuredebut" id="heuredebut">
                    ...
                    <i class="glyphicon glyphicon-remove-sign"></i> <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group">
                            <label for="heurefin">Heure Fin : </label>
                            <input type="time" class="form-control @error('heurefin') is-invalid @enderror heurefin_add" name="heurefin" id="heurefin">
                    ...
                    <i class="glyphicon glyphicon-remove-sign"></i> <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group">
                            <label for="heurepause">Heure Pause : </label>
                            <input type="time" class="form-control @error('heurepause') is-invalid @enderror heurepause_add" name="heurepause" id="heurepause">
...
@section('script')
    ...
    <script>
        ...
        {{--addv.addEventListener('submit', function(e) {--}}
        {{--    var begin = $('.heuredebut_add').val();--}}
        {{--    var end =$('.heurefin_add').val();--}}
        {{--    var datedeb = $('.datedebut_add').val();--}}
        {{--    var pause = $('.heurepause_add').val();--}}

        {{--    if(begin != '' && end != '' && datedeb != '' && pause != '' ) {--}}
        {{--        if(plannings[datedeb]) {--}}
        {{--            let planningVerification = plannings[datedeb] ;--}}
        {{--            dt1 = new Date("Mai 06 , 2020 "+begin+':00');--}}
        {{--            dt2 = new Date("Mai 06 , 2020 "+end+':00');--}}
        {{--            let diff = diff_hours(dt2,dt1);--}}
        {{--            console.log(diff);--}}
        {{--            e.preventDefault()--}}
        ...
        {{--var plannings = {!! $tableau !!};--}}
        {{--// console.log(plannings['2020-06-21']);--}}
