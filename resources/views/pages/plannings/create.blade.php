                        ...
                        <div class="col-lg-4 col-md-4">
                          <div class="input-group" style="margin-bottom:5px">
                            ...
                            <select name="generer_agent_name[]" class="form-control placeholder-select2" id="generer_agent_name" multiple="multiple" aria-placeholder="Choisir un agent">
                              {{-- <option value="" selected hidden>Choisir un agent</option> --}}
                              @if(count($agents)>0)
                              @foreach($agents as $agent)
                              <option value="{{$agent->id}}: {{$agent->nom.' '.$agent->prenoms}}" {{old('agent')==$agent->id ? 'selected' : null}}>{{$agent->nom.' '.$agent->prenoms}}</option>
                              @endforeach
                              @endif
                            </select>
                          </div>
...
{{--                <form method="post" id="user_form" data-route=" {{route('planning.store')}} ">--}}
                <form method="post" id="user_form" action=" {{route('planning.store')}} ">
                 @csrf
    ...
    $('#generer_agent_name').val().forEach(elmt => {
      ...
      for (let index = 0; index < dates.length; index++) {
        ...
        if ( (plannings[agent_id] === undefined) && (agent_name != undefined) ) {
          ...
          output += '<td> <input type="date" class="form-control with_input date_debut" value="'+date_debut+'" disabled /><input type="hidden" min="{{Carbon::now()->toDateString()}}" max="{{Carbon::now()->addWeek(6)->toDateString()}}" class="form-control" name="hidden_date_debut[]" id="date_debut'+count+'" value="'+date_debut+'" /></td>';
          ...
          if ( planningVerification.indexOf( date ) !== -1 ) {
            ...
            if ( ! creneauHoraireExiste(planningVerification, date, agent_id, userDebut, userFin) ) {
              ...
              output += '<td> <input type="date" class="form-control with_input" value="'+date_debut+'" disabled /><input type="hidden" min="{{Carbon::now()->toDateString()}}" max="{{Carbon::now()->addWeek(6)->toDateString()}}" class="form-control" name="hidden_date_debut[]" id="date_debut'+count+'" value="'+date_debut+'" /></td>';
          ...
          //     output += '<td><span class="text-uppercase agent_name form-control" style="border:none;">'+agent_name+'</span><input type="hidden" name="hidden_agent_name[]" id="agent_name'+count+'"value="'+agent_id+'" /></td>';
          //     output += '<td><span class="text-uppercase form-control" style="border:none;">'+site_name+'</span><input type="hidden" class="form-control" name="hidden_site_name[]" id="site_name'+count+'" value="'+site_id+'" /></td>';
          //     output += '<td> <input type="date" class="form-control" value="'+date_debut+'" disabled /><input type="hidden" min="{{Carbon::now()->toDateString()}}" max="{{Carbon::now()->addWeek(6)->toDateString()}}" class="form-control" name="hidden_date_debut[]" id="date_debut'+count+'" value="'+date_debut+'" /></td>';
          //     output += '<td> <input type="time" class="form-control" name="hidden_heure_debut[]" id="heure_debut'+count+'" value="'+heure_debut+'" /></td>';
          //     output += '<td> <input type="time" class="form-control" name="hidden_heure_fin[]" id="heure_fin'+count+'" value="'+heure_fin+'" /></td>';
          //     output += '<td> <input type="time" class="form-control" name="hidden_heure_pause[]" id="heure_pause'+count+'" value="'+heure_pause+'" /></td>';
        ...
        //   output += '<td><span class="text-uppercase agent_name form-control" style="border:none;">'+agent_name+'</span><input type="hidden" name="hidden_agent_name[]" id="agent_name'+count+'"value="'+agent_id+'" /></td>';
        //   output += '<td><span class="text-uppercase form-control" style="border:none;">'+site_name+'</span><input type="hidden" class="form-control" name="hidden_site_name[]" id="site_name'+count+'" value="'+site_id+'" /></td>';
        //   output += '<td> <input type="date" min="{{Carbon::now()->toDateString()}}" max="{{Carbon::now()->addWeek(6)->toDateString()}}" class="form-control" name="hidden_date_debut[]" id="date_debut'+count+'" value="'+date_debut+'" disabled /></td>';
        //   output += '<td> <input type="time" class="form-control" name="hidden_heure_debut[]" id="heure_debut'+count+'" value="'+heure_debut+'" /></td>';
        //   output += '<td> <input type="time" class="form-control" name="hidden_heure_fin[]" id="heure_fin'+count+'" value="'+heure_fin+'" /></td>';
        //   output += '<td> <input type="time" class="form-control" name="hidden_heure_pause[]" id="heure_pause'+count+'" value="'+heure_pause+'" /></td>';
