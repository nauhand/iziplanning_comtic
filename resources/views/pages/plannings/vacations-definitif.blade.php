                                    ...
                                    <div class="box-header" style="position: absolute; z-index: 1;">
                                        ...
                                        <div class="box-tools pull-left" style="margin-right: 15px">
                                            <div class="input-group input-group-sm hidden-xs" style="width: 30px;">
                                                <a class="btn btn-sm btn-social btn-vk generer-pdfIndiv" href="{{ route('planning.definitif.vaccation.pdf', $agent->id)}}" target="_blank" style="background-color: #c72121;">
                                        ...
                                        <div class="box-tools pull-left" style="margin-right: 15px">
                                            <div class="input-group input-group-sm hidden-xs" style="width: 30px;">
                                                <a class="btn btn-sm btn-social btn-vk generer-excelIndiv" href="{{ route('planning.definitif.vaccation.excel', $agent->id)}}" target="_blank" style="background-color: #0b7728;">
